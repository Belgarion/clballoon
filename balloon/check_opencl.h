...
#define CHECK_clCreateCommandQueueWithProperties(a,b,c,lbl)	\
    clCreateCommandQueueWithProperties(a,b,c,&CHECK_ret);	\
    CHECKRET_("clCreateCommandQueueWithProperties", lbl);
